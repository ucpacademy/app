            ...
            <div className="flex flex-col md:flex-row gap-6 justify-between items-start">
              ...
              <div className="flex flex-row md:flex-col justify-end gap-2 shrink-0 w-full md:w-auto">
                <button
                  ...
                  className={`flex items-center justify-center gap-2 px-4 py-2 rounded-xl text-sm font-medium transition-colors ${isResolved ? 'bg-slate-100 hover:bg-slate-200 text-slate-700 dark:bg-slate-800 dark:hover:bg-slate-700 dark:text-slate-300' : 'bg-emerald-50 hover:bg-emerald-100 text-emerald-700 dark:bg-emerald-500/10 dark:hover:bg-emerald-500/20 dark:text-emerald-400'}`}
                >
                  {isResolved ? (
                    <>
